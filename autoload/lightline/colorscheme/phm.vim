...
let s:phm_termcolors = get(g:, 'phm_termcolors', 256)
if s:phm_termcolors != 256 && &t_Co >= 16
  let s:cuiindex = 0
elseif s:phm_termcolors == 256
  let s:cuiindex = 1
else
  let s:cuiindex = 2
endif
...
let g:lightline#colorscheme#phm#palette = lightline#colorscheme#flatten(s:p)
