...
## TODO List
* [x] replace nerdtree with vimfiler: gisphm/myvimrc@baa4ecf3062f0d3883451bdabb2080ead39db51e

* [x] fix arrow key and esc mapping error: gisphm/myvimrc@eed0cb099cdf6051b32b8d28514c47b0f1a148eb

* [x] split plugins list: gisphm/myvimrc@c4656b10b61a40d37909d3aae4da8ae8580d37dd

* [x] split plugins settings: gisphm/myvimrc@294c0c70f7179a236e39d088fcb0fd3300312ae1

* [x] write some mappings of `unite.vim` acting as `ctrlp.vim`: gisphm/myvimrc@a59c85e605dcfaffc70ce17a74b6115e503c3c44
...
+ 之所以用 [neobundle][4] 而不是 [vundle][3]，纯粹是因为当时凑巧`vundle`用不了，
    各种无奈下只好用了`neobundle`: gisphm/myvimrc@94b0d32078f76ba21120133a4f1c1297ee4865cb
